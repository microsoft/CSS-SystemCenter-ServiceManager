...
- Download the below 2 files:
  -  [build_scdm_db.sql](https://microsoft.github.io/CSS-SystemCenter-ServiceManager/Misc/build_scdm_db.sql)
  -  [build_scdw_db.sql](https://microsoft.github.io/CSS-SystemCenter-ServiceManager/Misc/build_scdw_db.sql)
